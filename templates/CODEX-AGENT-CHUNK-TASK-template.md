...
This is not a generic companion transcript. Codex's behavior includes natural-language replies, tool choice, verification habits, repair moves, and boundaries around project-specific systems.
...
- How Codex protects repo boundaries between different projects, services, and companion stacks.
...
How does Codex distinguish its own behavior from other companion systems or project roles? Where does it preserve another system's ownership?
